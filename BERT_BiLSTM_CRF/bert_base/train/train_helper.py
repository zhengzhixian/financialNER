...
def get_args_parser():
    ...
    group1.add_argument('-data_dir', type=str, default=data_dir,
                        help='train, dev and test data dir')
    group1.add_argument('-bert_config_file', type=str, default=bert_config_file)
    group1.add_argument('-output_dir', type=str, default=output_dir,
                        help='directory of a pretrained BERT model')
    group1.add_argument('-init_checkpoint', type=str, default=init_checkpoint,
                        help='Initial checkpoint (usually from a pre-trained BERT model).')
    group1.add_argument('-vocab_file', type=str, default=vocab_file,
                        help='')
    ...
    # add labels
    group2.add_argument('-label_list', type=str, default='B-ORG,I-ORG,O',
