...
from loader import load_sentences_1, update_tag_scheme,load_sentences
...
flags.DEFINE_string("ckpt_path",    "ckpt_finance",     "Path to save model")
flags.DEFINE_string("summary_path", "summary_finance",      "Path to store summaries")
flags.DEFINE_string("log_file",     "train_finance.log",    "File for log")
flags.DEFINE_string("map_file",     "maps.pkl",     "file for maps")
flags.DEFINE_string("vocab_file",   "vocab.json",   "File for vocab")
flags.DEFINE_string("config_file",  "config_file",  "File for config")
flags.DEFINE_string("script",       "conlleval_finance",    "evaluation script")
flags.DEFINE_string("result_path",  "result_finance",       "Path for results")
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        for i in tqdm(range(len(Test))):
            ...
            if sentence_title!='nan':
                #evaluate 返回的为list
                result_title = model.evaluate_line(sess, input_from_line(sentence_title, char_to_id), id_to_tag)
            ...
            if sentence_text!='nan':
                result_text = model.evaluate_line(sess, input_from_line(sentence_text, char_to_id), id_to_tag)
